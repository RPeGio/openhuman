...
本文件夹包含 OpenHuman 项目的学习资料。

## 文件索引

| 文件 | 内容 |
| --- | --- |
| [`LEARNING_GUIDE.md`](LEARNING_GUIDE.md) | 完整学习路线图：前置知识、四大阶段、子系统深入、学习技巧 |
...
1. 先读 [`LEARNING_GUIDE.md`](LEARNING_GUIDE.md) 了解全局
2. 再看 [`30_LESSON_CURRICULUM.md`](30_LESSON_CURRICULUM.md) 了解每节课的范围
3. 从 `lesson-01-overview.md` 开始，按顺序学习每节课
